...
const BentoItems = ({
  ...
  return (
    <Card className={classes.card}>
      <CardMedia className={classes.media} image={image} title={nameofbento} />
...
BentoItems.defaultProps = {
  showActions: true
};

BentoItems.propTypes = {
...
export default connect(mapStateToProps, { deleteBento })(BentoItems);
